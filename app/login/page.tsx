        ...
        <div className="bg-[#211a14] rounded-xl shadow-2xl border border-amber-900/30 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <svg
                  className="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-stone-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              {loading ? (
                <>
                  <svg
                    className="animate-spin w-5 h-5 text-stone-950"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <circle
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#211a14] text-stone-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-amber-900/30 bg-[#18130e] text-stone-200 font-medium py-3 rounded-lg hover:bg-[#282018] hover:border-amber-900/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
