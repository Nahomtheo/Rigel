        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="text-center mb-10">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-4 leading-tight">
              Ethiopia\'s <span className="text-blue-200 dark:text-blue-400">Premium</span> Marketplace
            </h1>
          ...
          {/* Search Bar */}
          <form onSubmit={handleSearch} className="max-w-4xl mx-auto bg-white dark:bg-gray-700 rounded-xl shadow-lg p-2">
            <div className="flex flex-col md:flex-row gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-4 py-3 rounded-lg text-gray-900 dark:text-white bg-transparent text-lg focus:ring-0 focus:outline-none"
                />
              </div>
              <button
                type="submit"
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-3 rounded-xl transition-all duration-200
                    ${selectedCategory === category.id
                      ...
                      : 'bg-white/20 hover:bg-white/30 text-white dark:text-gray-200'}
                  `}
                >
