      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            {error && (
              ...
              >
                ...
                <button
                  ...
                  className="absolute right-2 top-2 flex h-7 w-7 items-center justify-center rounded-md text-red-500 transition hover:bg-red-100 hover:text-red-700"
                >
                  <svg
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 bg-white text-gray-700 font-medium py-3 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
