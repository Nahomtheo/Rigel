  ...
  const [previewImages, setPreviewImages] = useState<string[]>([]);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        console.log("Finished submitting listing.");
      }
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-lg p-6 hover:border-blue-400 transition-colors">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 text-sm mb-2">Drag and drop images here, or click to select</p>
                <input
                  name="images"
                  type="file"
                  multiple
